...
class StaffStaticInsightsWidget extends StatefulWidget {
  final Function(String)? onInsightTap;

  const StaffStaticInsightsWidget({super.key, this.onInsightTap});

  @override
  State<StaffStaticInsightsWidget> createState() =>
      _StaffStaticInsightsWidgetState();
}

class _StaffStaticInsightsWidgetState extends State<StaffStaticInsightsWidget>
  ...
  Future<void> _loadData() async {
    try {
      ...
      double avgAttendance = studentCount > 0
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          ...
                          colors: [Color(0xFF001FF4), Color(0xFF764BA2)],
                        ),
                    ...
                    GestureDetector(
                      onTap: () {
                        if (widget.onInsightTap != null) {
                          widget.onInsightTap!(
                            "Analyze faculty metrics: ${_metrics['students'] ?? 0} students, ${_metrics['attendance']?.toStringAsFixed(1) ?? '0'}% avg attendance, ${_metrics['lowAttendance'] ?? 0} at risk.",
                          );
                        }
                      },
                      child: Container(

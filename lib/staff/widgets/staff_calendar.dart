...
class StaffRightPanel extends StatefulWidget {
  const StaffRightPanel({super.key});

  @override
  State<StaffRightPanel> createState() => _StaffRightPanelState();
}

class _StaffRightPanelState extends State<StaffRightPanel> {

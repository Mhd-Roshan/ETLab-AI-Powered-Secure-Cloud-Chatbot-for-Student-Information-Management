...
class AiChatScreen extends StatefulWidget {
  ...
  final String? userId;
  const AiChatScreen({super.key, this.initialPrompt, this.userId});
...
class _AiChatScreenState extends State<AiChatScreen> {
  ...
  String _currentResponse = """# Welcome to Staff Intelligence! 🧑‍🏫📖

I'm your dedicated Assistant for **Academic & Faculty Tasks**. I have real-time access to your students' data and academic schedules.

## 🎤 **Faculty Voice Tools**
- **Voice Commands**: Ask about your class status or student progress
- **Instant TTS**: Response playback for hands-free updates

## 📚 **Faculty-Centric Data**
- **Students**: Quick lookup of attendance and performance
- **Performance**: Identify students needing academic support
- **Exams**: Details on invigilation schedules and venues
- **Syllabus**: Search through KTU MCA/MBA curriculum details

## 💡 **Try These Faculty Queries**
- *"Identify students with attendance below 75%"*
- *"Show me upcoming exams I need to coordinate"*
- *"What is the GPA trend for the current MCA batch?"*
- *"Help me find the KTU syllabus for Machine Learning"*

**Ready to assist with your academic duties. What can I help you with today?**
""";
  ...
  void initState() {
    super.initState();
    _currentUserId = widget.userId ?? 'staff_member';
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _currentResponse =
              "**Error Processing Request**\n\nThere was an issue: $e\n\n**Try asking:**\n- Show me students with low attendance\n- When are the next university exams?\n- Summarize the ML batch performance";
        });
      }
    } finally {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          StaffSidebar(activeIndex: 1, userId: _currentUserId),
          Expanded(
            child: Row(
              children: [
                Container(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Faculty Mode • Student Analytics • Academic Support",
                                    style: const TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey,
                                    ),
                            ...
                            children: [
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: _isVoiceMode
                                            ...
                                            : "Ask about students, exams, or syllabus...",
                                        filled: true,
                              ...
                              Wrap(
                                ...
                                children: [
                                  ...
                                  _buildQuickActionButton(
                                    "🎓 Performance",
                                    "Show me GPA trends for my departments",
                                  ),
                                  _buildQuickActionButton(
                                    "📅 Exam Schedule",
                                    "Show me upcoming university exams",
                                  ),
                                  _buildQuickActionButton(
                                    "📖 Syllabus Search",
                                    "Show me KTU syllabus for MCA Semester 3",
                                  ),
                                  _buildQuickActionButton(
                                    "📝 Assignment Stats",
                                    "Summary of pending student assignments",
                                  ),
                                  _buildQuickActionButton(
                                    "🏫 Class Overview",
                                    "Give me a summary of current batch metrics",
                                  ),
                                ],
                              ),
                            ],

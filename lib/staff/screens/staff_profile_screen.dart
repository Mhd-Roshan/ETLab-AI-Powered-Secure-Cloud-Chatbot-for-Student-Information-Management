...
class _StaffProfileScreenState extends State<StaffProfileScreen> {
  StaffService? _serviceInstance;
  StaffService get service => _serviceInstance ??= StaffService();
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || !snapshot.data!.exists) {
            // Provide default values if document doesn't exist yet
            return _buildProfileUI({
              ...
              'notifications': true,
              'darkMode': false,
              'subjects': 'Digital Foundation, Computer Architecture',
            });
          }
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Overlapping Glass Profile Card

...
class EnhancedAiChatScreen extends StatefulWidget {
  ...
  final String? userId;
  const EnhancedAiChatScreen({super.key, this.initialPrompt, this.userId});
...
class _EnhancedAiChatScreenState extends State<EnhancedAiChatScreen> {
  ...
  void initState() {
    super.initState();
    _currentUserId = widget.userId ?? 'admin';
    _initializeServices();
        ...
        content: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isSelected =
                  lang['code'] == _translationService.currentLanguage;
        ...
        children: [
          ...
          if (_isSpeaking)
            ...
            IconButton(
              ...
              icon: const Icon(Icons.volume_up, color: Color(0xFF001FF4)),
              tooltip: "Read aloud",
            ),
        ],
      ),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.history, color: Color(0xFF001FF4)),
                            ...
                            child: _isLoading
                                ? Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        _translationService.getLocalizedText(
                                          'processing',
                                        ),
                                        style: TextStyle(
                                          color: Colors.grey.shade600,

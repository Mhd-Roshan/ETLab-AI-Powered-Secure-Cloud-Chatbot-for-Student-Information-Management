...
class _StaffAdvisorDashboardState extends State<StaffAdvisorDashboard> {
  ...
  Widget _buildNavItem(
    ...
    Color bg = isPrimary
        ...
        : (isActive ? Colors.grey[100]! : Colors.transparent);
    Color text = isPrimary
        ? primaryBlue
        : (isActive ? textGray900 : textGray500);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isActive
            ...
            : surfaceLight, // Dark Slate for Active
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                        color: const Color(0xFFC7D2FE).withOpacity(0.7),
                        fontSize: 14,
                      ),
                      border: InputBorder.none,
                    ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Spacer(),
          const Text(
            "Deep dive into student performance with instant reports.",
            style: TextStyle(
              color: Colors.white,
              fontSize: 14,
              fontWeight: FontWeight.w500,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            item['sub'],
            textAlign: TextAlign.center,
            style: TextStyle(color: textGray500, fontSize: 11),
          ),
        ],
      ),
    );

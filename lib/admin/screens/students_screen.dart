                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInput(
                        ...
                        regCtrl,
                        isEnabled: !isEdit,
                      ), // Usually RegNo shouldn't change
                      const SizedBox(height: 16),
                      Row(
                        children: [
                    ...
                    : () async {
                        if (formKey.currentState!.validate()) {
                          ...
                          try {
                            ...
                            final regQuery = await db
                                .where('registrationNumber', isEqualTo: regNo)
                                .get();
                            if (regQuery.docs.isNotEmpty &&
                                (!isEdit || regQuery.docs.first.id != docId)) {
                              _showMsg(
                                "Registration Number '$regNo' already exists!",
                                isError: true,
                              );
                            ...
                            if (emailQuery.docs.isNotEmpty &&
                                (!isEdit ||
                                    emailQuery.docs.first.id != docId)) {
                              _showMsg(
                                "Email '$email' is already assigned to another student!",
                                isError: true,
                              );
                              setDialogState(() => _isProcessing = false);
                              return;
